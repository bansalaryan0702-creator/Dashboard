  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        throw new Error('Server returned invalid data (likely HTML). Are you hosting on a static platform like Cloudflare Pages without a backend?');
      }
      ...
      if (data.user) {
        login(data.user);
        navigate(data.user.role === 'admin' ? '/admin' : data.user.role === 'manager' ? '/manager' : '/employee');
      } else {
